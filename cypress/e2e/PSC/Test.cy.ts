describe('Ver tela de login', () => {
  beforeEach(() => {
    ...
    cy.get("body > div:nth-child(6) > div > div.ant-modal-wrap > div > div.ant-modal-content > div > div > input:nth-child(2)").type('leonardo.gomes@venicetech.com.br')
    cy.get("body > div:nth-child(6) > div > div.ant-modal-wrap > div > div.ant-modal-content > div > div > input:nth-child(3)").type('teste')
